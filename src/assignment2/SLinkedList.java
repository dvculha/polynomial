//Dafne Culha - 260785524 - COMP 250 - Assignment2
package assignment2;
...
public class SLinkedList<E extends DeepClone<E>> implements Iterable<E>
{
	 ...
	 *  Hint: Use E.deepCopy().
	 */
	public SLinkedList<E> deepClone() // O(n) complexity
	//throws CloneNotSupportedException
	{
		SLinkedList<E> otherList = new SLinkedList <E>();
	...
	//	otherList.size = this.size;
		...
		for (E currentTerm: this) {
			otherList.addLast(currentTerm.deepClone());
			//currentTerm.equals(this.get(k));
			//currentTerm = this.get(k);
			//k++;
		}
		return otherList;
		//return null;
